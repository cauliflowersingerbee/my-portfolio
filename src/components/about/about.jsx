...
export default class AboutView extends React.Component {  
    ...
    render() {
      ...
      <div id='about-me'>About Me</div>
        <div id='about-text'>
        I am a fiction writer who, after years of interest in programming, finally scratched the itch and ventured into tech. I now write both stories and code. I like designing user experience too. I am skilled in JavaScript, Node.js, React, React Native, and Angular. I am also skilled in UX research, wireframing, prototyping, and usability testing.  
