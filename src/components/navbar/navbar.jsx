...
<Navbar expand="lg" className='justify-content-between' style={{zIndex: '2'}}>
  <Container>
  <Navbar.Brand href="/">
      <img id='logo-img' src={LogoImage} alt='website logo'  className="d-inline-block align-top" style={{width: '50%', height:'auto', margin:'1px'}}/>
  </Navbar.Brand>
    <Navbar.Toggle aria-controls="responsive-navbar-nav" />
    <Navbar.Collapse id="responsive-navbar-nav" className='justify-content-end'>
      <Nav className="me-auto navbar-nav ms-auto" style={{float: 'right'}}>
          <Nav.Link href="/my-portfolio/" id='home-link' style={{  marginRight: '30px', color: '#000', fontWeight: '400', textTransform: 'lowercase', fontFamily: 'Roboto-Slab', fontSize: '20px', lineHeight: '2px', marginTop:'10px' }}>HOME</Nav.Link>
